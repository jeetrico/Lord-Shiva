...
class sketch_from_svg:
    ...
    def load_svg(self):
        ...
        for i in tqdm(attributes):
            path = Path(i['d'])
            # Handle missing 'fill' attribute by providing a default color
            co = i.get('fill', '#000000')  # Default to black if 'fill' is not present
...
pen = sketch_from_svg("C:\\Users\\jeetr\Downloads\\shivji.svg", scale=80)
